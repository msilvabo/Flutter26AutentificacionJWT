...
import 'package:teslo_shop/features/shared/services/camera_gallery_service.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          CustomProductField(
            isTopField: true,
            label: 'Nombre',
            initialValue: productForm.tittle.value,
            onChanged:
                ref.read(productFormProvider(product).notifier).onTitleChange,
            errorMessage: productForm.tittle.errorMessage,
          ),
          CustomProductField(
            label: 'Slug',
  ...
  Widget build(BuildContext context) {
    return Center(
      child: SegmentedButton(
        ...
        onSelectionChanged: (newSelection) {
          FocusScope.of(context).unfocus();
          onGenderChange(newSelection.join(','));
        },
      ),
    );
  }
